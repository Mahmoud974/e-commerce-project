        ...
        <div className="container mt-6 mx-auto">
          <div className="mt-12 text-center px-4 mb-12">
            ...
            <p className="text-white text-lg mt-6 max-w-3xl mx-auto">
              ...
              espaces avec un design iconique Timeless qui apporte joie et
              inspiration.
            </p>
          ...
          <div>
            <div
              className="bg-red-700 w-1/3 h-3 mb-8"
              role="separator"
              aria-hidden="true"
            ></div>
            <p>
            ...
            <ul
              className="flex mt-8 flex-col flex-wrap md:flex-row text-center gap-12 items-center justify-between"
              role="list"
              ...
              <li className="flex flex-col items-center" role="listitem">
                <div className="w-96 h-96 bg-gray-200 overflow-hidden rounded-lg">
                  <Image
                    ...
                    width={500}
                    height={500}
                    alt="Image représentant la forme, avec un design minimaliste"
              ...
              <li className="flex flex-col items-center" role="listitem">
                <div className="w-96 h-96 bg-gray-200 overflow-hidden rounded-lg">
                  <Image
                    ...
                    width={500}
                    height={500}
                    alt="Sensation d'une assise confortable"
                    className="object-cover w-full h-full"
                  />
                </div>
              ...
              <li className="flex flex-col items-center" role="listitem">
                <div className="w-96 h-96 bg-gray-200 overflow-hidden rounded-lg">
                  <Image
                    ...
                    width={500}
                    height={500}
                    alt="Fonctionnalité d'un meuble alliant design et utilité"
                    className="object-cover w-full h-full"
                  />
                </div>
                ...
                <p className="mt-2 max-w-xs">
                  Nos designs allient forme et praticité, perpétuant la
                  tradition du design danois qui met l'accent sur la
                  fonctionnalité et l'ergonomie.
                </p>
              </li>
            </ul>
          </div>
