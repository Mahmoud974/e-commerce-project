    ...
    >
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          ...
          l'utilisant, vous acceptez de respecter ces conditions. Si vous n'êtes
          pas d'accord avec ces conditions, veuillez ne pas utiliser notre site.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Vous êtes responsable de l'accès à notre site, y compris de tous les
          équipements nécessaires pour y accéder. L'accès au site peut être
          temporairement suspendu pour des raisons techniques ou pour des mises
          à jour.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          ...
          par des droits de propriété intellectuelle. Vous n'êtes pas autorisé à
          reproduire, distribuer, ou modifier ces contenus sans notre
          autorisation préalable.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-medium text-white">Utilisation du site</h2>
        <p className="text-lg text-gray-600">
          Vous vous engagez à utiliser notre site uniquement à des fins légales
          et conformément aux lois en vigueur. Vous acceptez de ne pas utiliser
          notre site de manière à nuire à son bon fonctionnement ou à perturber
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          En utilisant notre site, vous vous engagez à ne pas publier de contenu
          illégal, diffamatoire, obscène, ou toute autre forme de contenu qui
          pourrait porter atteinte aux droits d'autrui ou enfreindre les lois
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Notre site peut contenir des liens vers d'autres sites web qui ne sont
          pas sous notre contrôle. Nous ne sommes pas responsables du contenu de
          ces sites externes et nous vous recommandons de lire leurs politiques
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          ...
          à tout moment. Les modifications seront publiées sur cette page et
          entreront en vigueur dès leur publication. Il est de votre
          responsabilité de consulter régulièrement cette page pour prendre
