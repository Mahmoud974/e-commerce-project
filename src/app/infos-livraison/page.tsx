    ...
    >
      <main className="relative">
        <div className="container my-6 mx-auto">
          <article className="mt-12 text-center px-4 mb-12">
          ...
          <section aria-labelledby="delivery-estimates">
            ...
            <ul className="flex flex-col sm:flex-row mt-8 gap-12 items-center justify-start sm:space-x-8">
              <li className="flex flex-col items-center w-full sm:w-1/3">
                <figure className="w-full h-72 bg-gray-200 overflow-hidden rounded-lg">
                  <Image
                    src={baseImageUrl + "/art2.jpg"}
                    width={500}
                    height={500}
                    alt="Meubles en bois fabriqués artisanalement"
                    className="object-cover w-full h-full"
                  />
                </figure>
                <h3 className="text-red-600 text-center mt-4 text-xl font-bold">
              ...
              <li className="flex flex-col items-center w-full sm:w-1/3">
                <figure className="w-full h-72 bg-gray-200 overflow-hidden rounded-lg">
                  <Image
                    ...
                    width={500}
                    height={500}
                    alt="Meubles capitonnés de haute qualité"
                    className="object-cover w-full h-full"
                  />
                </figure>
                <h3 className="text-red-600 text-center mt-4 text-xl font-bold">
              ...
              <li className="flex flex-col items-center w-full sm:w-1/3">
                <figure className="w-full h-72 bg-gray-200 overflow-hidden rounded-lg">
                  <Image
                    ...
                    width={500}
                    height={500}
                    alt="Chaises et fauteuils design"
                    className="object-cover w-full h-full"
                  />
                </figure>
                <h3 className="text-red-600 text-center mt-4 text-xl font-bold">
                  Chaises et fauteuils : 4 à 6 semaines
                </h3>
                <p className="mt-2 text-center sm:max-w-xs">
