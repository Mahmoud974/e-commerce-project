        ...
        <div className="container mt-6 mx-auto">
          ...
          <div className="mt-12 text-center px-4 mb-12">
            <p className="text-white text-xl font-semibold mt-4 max-w-3xl mx-auto">
              ...
              après le 1er janvier 2022. Cette garantie s’ajoute à vos droits
              prévus par la loi et témoigne de notre volonté de vous fournir un
          ...
          <div>
            ...
            <p className="text-white text-lg max-w-3xl mx-auto mb-8 lg:px-0 px-6">
              ...
              faisons un pas de plus en proposant une garantie de 10 ans
              couvrant les défauts de fabrication et de structure.
            </p>
